...
const me: BillingMe = { plan: "lite", status: "active", plans: [{ id: "lite", priceUsdCents: 1900, capabilities: { image: false, video: false } }], windows: null, addon: { remainingMicro: 0, expiresAt: null }, periodEnd: null, models: [], modelPlatforms: {} };
