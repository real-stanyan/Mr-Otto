...
export const ICON_NAMES = ["3d","abap","abc","actionscript","ada","adobe-illustrator","adobe-photoshop","adobe-swc","adonis","advpl","amplify","android","angular","antlr","apiblueprint","apollo","applescript","apps-script","appveyor","appwrite","architecture","arduino","asciidoc","assembly","astro","astro-config","astyle","audio","aurelia","authors","auto","autohotkey","autoit","azure","azure-pipelines","babel","ballerina","bashly","bazel","bbx","beancount","bench-js","bench-jsx","bench-ts","bibliography","bibtex-style","bicep","biome","bitbucket","bithound","blender","blink","blitz","bower","brainfuck","browserlist","bruno","buck","bucklescript","buildkite","bun","c","c3","cabal","caddy","cadence","cairo","cake","capacitor","capnp","cbx","cds","certificate","changelog","chess","chromatic","chrome","circleci","citation","clangd","claude","cline","clojure","cloudfoundry","cmake","coala","cobol","coconut","code-climate","codecov","codeowners","coderabbit-ai","coffee","coldfusion","coloredpetrinets","command","commitizen","commitlint","concourse","conduct","console","contentlayer","context","contributing","controller","copilot","cpp","craco","credits","crystal","csharp","css","css-map","cucumber","cuda","cue","cursor","cypress","d","dart","dart_generated","database","deepsource","denizenscript","deno","dependabot","dependencies-update","dhall","diff","dinophp","disc","django","dll","docker","doctex-installer","document","dotjs","drawio","drizzle","drone","duc","dune","edge","editorconfig","ejs","elixir","elm","email","ember","epub","erlang","esbuild","eslint","excalidraw","exe","expo","fastlane","favicon","figma","file","firebase","flash","flow","folder","font","forth","fortran","foxpro","freemarker","fsharp","fusebox","gamemaker","garden","gatsby","gcp","gemfile","gemini","gemini-ai","git","github-sponsors","gitlab","gitpod","gleam","gnuplot","go","go-mod","godot","godot-assets","google","gradle","grafana-alloy","grain","graphcool","graphql","gridsome","groovy","grunt","gulp","h","hack","hadolint","haml","handlebars","happo","hardhat","harmonix","haskell","haxe","hcl","helm","heroku","hex","hip","histoire","hjson","horusec","hosts","hpp","html","http","huff","hurl","husky","i18n","idris","ifanr-cloud","image","imba","installation","ionic","istanbul","jar","java","javaclass","javascript","javascript-map","jenkins","jest","jinja","jsconfig","json","json_schema","jsr","julia","jupyter","just","karma","kcl","key","keystatic","kivy","kl","knip","kotlin","kubernetes","kusto","label","laravel","latexmk","lbx","lean","lefthook","lerna","less","liara","lib","license","lighthouse","lilypond","lintstaged","liquid","lisp","livescript","lock","log","lolcode","lottie","lua","luau","lynx","lyric","macaulay2","makefile","markdoc","markdoc-config","markdown","markdownlint","markojs","mathematica","maven","mdsvex","mdx","mercurial","merlin","mermaid","meson","metro","minecraft","minecraft-fabric","mint","mjml","mocha","modernizr","mojo","moon","moonscript","mrpack","mxml","nano-staged","ndst","nest","netlify","next","nginx","nim","nix","nodejs","nodemon","npm","nuget","nunjucks","nuxt","nx","objective-c","objective-cpp","ocaml","odin","onnx","opa","opam","openapi","opencode","opentofu","otne","oxc","packship","palette","panda","parcel","pascal","pawn","payload","pdf","pdm","percy","perl","php","php-cs-fixer","phpstan","phpunit","pinejs","pipeline","pkl","plastic","playwright","plop","pm2-ecosystem","pnpm","poetry","postcss","posthtml","powerpoint","powershell","pre-commit","prettier","prisma","processing","prolog","prompt","proto","protractor","pug","puppet","puppeteer","purescript","python","python-misc","pytorch","qsharp","quarto","quasar","quokka","r","racket","raml","razor","rbxmk","rc","react","react_ts","readme","reason","red","regedit","remark","remix","renovate","replit","rescript","rescript-interface","restql","riot","roadmap","roblox","robot","robots","rocket","rolldown","rollup","rome","routing","rspec","rstack","rubocop","ruby","ruff","rust","salt","san","sas","sass","sbt","scala","scheme","scons","screwdriver","search","semantic-release","semgrep","sentry","sequelize","serverless","settings","shader","shellcheck","simulink","siyuan","sketch","skill","slim","slint","slug","smarty","sml","snakemake","snapcraft","snowpack","snyk","solidity","sonarcloud","spwn","stackblitz","stan","steadybit","stencil","stitches","storybook","stryker","stylable","stylelint","stylus","sublime","subtitles","supabase","svelte","svg","svgo","svgr","swagger","sway","swc","swift","syncpack","table","tailwindcss","taskfile","tauri","taze","tcl","teal","templ","template","terraform","test-js","test-jsx","test-ts","tex","textlint","tilt","tldraw","tobi","tobimake","toc","todo","toml","toon","travis","tree","trigger","tsconfig","tsdoc","tsdown","tsil","tune","turborepo","twig","twine","typedoc","typescript","typescript-def","typst","uiua","umi","uml","unity","unlicense","unocss","url","uv","vagrant","vala","vanilla-extract","varnish","vedic","velite","velocity","vercel","verdaccio","verified","verilog","verse","vfl","video","vim","virtual","visualstudio","vite","vitest","vlang","vscode","vue","vue-config","wakatime","wallaby","wally","warp","watchman","webassembly","webhint","webpack","wepy","werf","windicss","wolframlanguage","word","wrangler","wxt","xaml","xmake","xml","yaml","yang","yarn","zeabur","zig","zip"] as const;
