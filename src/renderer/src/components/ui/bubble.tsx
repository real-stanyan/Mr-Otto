// shadcn/ui bubble(new-york-v4 registry)。改动仅 import 后缀 + 去 "use client"。
  ...
  "group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
        ...
        tinted:
          "*:data-[slot=bubble-content]:bg-[color-mix(in_srgb,var(--brand)_18%,var(--card))] *:data-[slot=bubble-content]:text-foreground [&>[data-slot=bubble-content]:is(button,a):hover]:bg-[color-mix(in_srgb,var(--brand)_26%,var(--card))]",
        outline:
