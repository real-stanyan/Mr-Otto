...
function ToolGroupTrigger({
  ...
  return (
    <CollapsibleTrigger
      ...
      className={cn(
        "aui-tool-group-trigger group/trigger flex origin-left items-center gap-2 text-sm transition-[color,scale] ease-strong active:scale-[0.98]",
    ...
    >
      <div
        className={cn(
          ...
          "[&>*]:animate-content-reveal-in [&>*]:[--tw-duration:var(--animation-duration)] [&>*]:ease-strong",
