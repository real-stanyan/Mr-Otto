      ...
      {isMounted &&
        ...
        createPortal(
          <div
            ...
            role="button"
            tabIndex={0}
            className="aui-image-zoom-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/80 transition-opacity duration-200 ease-strong starting:opacity-0"
            onClick={handleClose}
          ...
          >
            <img
              ...
              src={src}
              alt={alt}
              className="aui-image-zoom-content max-h-[90vh] max-w-[90vw] cursor-zoom-out object-contain transition-[opacity,transform] duration-200 ease-strong starting:opacity-0 starting:scale-95 motion-reduce:transition-opacity motion-reduce:starting:scale-100"
              onClick={(e) => {
                e.stopPropagation();
                handleClose();
              }}
