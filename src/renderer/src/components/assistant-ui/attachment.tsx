...
const AttachmentPreview: FC<AttachmentPreviewProps> = ({ src }) => {
  ...
  return (
    <img
      ...
      className={cn(
        "block h-auto max-h-[80vh] w-auto max-w-full rounded-sm object-contain transition-opacity duration-300 ease-strong motion-reduce:transition-none",
        isLoaded
      ...
      <Tooltip>
        <AttachmentPrimitive.Root
          className={cn(
            ...
            isComposer &&
              "transition-[opacity,transform] duration-200 ease-strong starting:opacity-0 starting:scale-95 motion-reduce:transition-opacity motion-reduce:starting:scale-100",
            isImage &&
              !isComposer &&
            ...
            <TooltipTrigger asChild>
              ...
              >
                ...
                {isUploading && (
                  <div
                    aria-hidden="true"
                    className="aui-attachment-tile-uploading bg-background/60 absolute inset-0 flex items-center justify-center backdrop-blur-[2px] transition-opacity duration-150 ease-strong starting:opacity-0"
                  >
                ...
                {isError && (
                  <div
                    aria-hidden="true"
                    className="aui-attachment-tile-error bg-background/70 absolute inset-0 flex items-center justify-center backdrop-blur-[2px] transition-opacity duration-150 ease-strong starting:opacity-0"
                  >
