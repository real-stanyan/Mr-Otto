...
const bridge: ShellBridge = {
  ...
  taskSyncStatus: () => ipcRenderer.invoke(CHANNELS.taskSyncStatus),
  ...
  setMcpOAuthClient: (id, client) => ipcRenderer.invoke(CHANNELS.setMcpOAuthClient, id, client),
  ...
  onTaskSyncState: subscribe(CHANNELS.taskSyncState),
  onTaskWaiting: subscribe(CHANNELS.taskWaiting),
  onTaskSessionReplaced: subscribe(CHANNELS.taskSessionReplaced),
  ...
  workspaceCloudArchive: (workspaceId, sessionId) =>
    ipcRenderer.invoke(CHANNELS.workspaceCloudArchive, workspaceId, sessionId),
  workspaceCloudDelete: (workspaceId, sessionId) =>
    ipcRenderer.invoke(CHANNELS.workspaceCloudDelete, workspaceId, sessionId),
  workspaceCloudChatUpdate: (workspaceId, sessionId, patch) =>
  ...
  onSpeechEvent: subscribe(CHANNELS.speechEvent),
