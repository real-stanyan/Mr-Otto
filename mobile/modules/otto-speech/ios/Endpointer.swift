...
// 断句（#1356 A4，ADR-0320）：从桌面 native/MrOttoSpeech/Sources/MrOttoSpeech/Protocol.swift 逐字抄来——
// 从「一句是不是像说完了」那段注释起到文件末尾。tests/mobile/ottoSpeech.test.ts 对拍两份，改一边另一边不跟就红。
