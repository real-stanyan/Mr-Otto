...
- `src/renderer/src/components/SideChatWindow.tsx` / `src/renderer/src/lib/sideChatWindow.ts` — /btw 的 side chat 浮窗：打了 `sideChat` 标记的独立 session，对侧栏/⌘K 隐身，浮窗自己管历史（ADR-0128）
