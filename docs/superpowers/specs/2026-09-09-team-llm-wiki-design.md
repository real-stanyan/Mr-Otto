...
ADR：0282（ADR-0074 claim-at-merge：写稿时下一个空号是 0267，合并前与 main 上先落的 ADR 撞号，先改到 0279；合 origin/main 的语音那批时又撞上 #998 的 ADR-0279，再改到 0281，再撞 #758 改到 0282）；推翻 ADR-0222
