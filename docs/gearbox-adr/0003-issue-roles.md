...
- Date: 2026-07-17
- Provenance: copied from [gearbox ADR-0003](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0003-issue-roles.md) (gearbox-install init, upstream sha256:8609acfdfb07)
- Status: accepted
