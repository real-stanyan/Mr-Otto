...
- Date: 2026-07-17
- Provenance: copied from [gearbox ADR-0002](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0002-self-check-as-gate.md) (gearbox-install init, upstream sha256:1061278283d8)
- Status: accepted
