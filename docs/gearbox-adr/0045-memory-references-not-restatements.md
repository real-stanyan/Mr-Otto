...
- Date: 2026-07-23
- Provenance: copied from [gearbox ADR-0045](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0045-memory-references-not-restatements.md) (gearbox-install init, upstream sha256:06fc7ad5f0ff)
- Status: accepted
