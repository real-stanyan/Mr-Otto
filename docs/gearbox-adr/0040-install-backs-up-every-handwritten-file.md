...
- Date: 2026-07-22
- Provenance: copied from [gearbox ADR-0040](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0040-install-backs-up-every-handwritten-file.md) (gearbox-install init, upstream sha256:61a694d0ebc3)
- Status: accepted
