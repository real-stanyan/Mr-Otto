...
- Date: 2026-07-22
- Provenance: copied from [gearbox ADR-0036](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0036-install-maintainer-prompt.md) (gearbox-install init, upstream sha256:bcff40b37901)
- Status: accepted
