...
- Date: 2026-07-17
- Provenance: copied from [gearbox ADR-0008](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0008-division-of-labor-stays-a-placeholder.md) (gearbox-install init, upstream sha256:ec2b7fbe0c5c)
- Status: accepted
