...
- Date: 2026-07-17
- Provenance: copied from [gearbox ADR-0004](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0004-memory-comment-gets-a-rationale-slot.md) (gearbox-install init, upstream sha256:d7f7c1abd083)
- Status: accepted
