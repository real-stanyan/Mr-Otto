...
- Date: 2026-07-19
- Provenance: copied from [gearbox ADR-0014](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0014-pr-template-references-downstream-list.md) (gearbox-install init, upstream sha256:1c2aa01fe8e3)
- Status: accepted
