...
- Date: 2026-07-19
- Provenance: copied from [gearbox ADR-0019](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0019-definition-exemption-for-context-glossary.md) (gearbox-install init, upstream sha256:efd329b2f8ee)
- Status: accepted
