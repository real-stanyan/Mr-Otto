...
- Date: 2026-07-22
- Provenance: copied from [gearbox ADR-0039](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0039-install-auto-backs-up-handwritten-agents-md.md) (gearbox-install init, upstream sha256:3fa02cc28bdf)
- Status: accepted
