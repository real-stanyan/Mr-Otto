...
- Date: 2026-07-17
- Provenance: copied from [gearbox ADR-0007](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0007-pr-merge-rules.md) (gearbox-install init, upstream sha256:4897a1019ee2)
- Status: accepted
