...
- Date: 2026-07-22
- Provenance: copied from [gearbox ADR-0038](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0038-install-guard-splits-on-provenance.md) (gearbox-install init, upstream sha256:6739ddd511e6)
