...
- Date: 2026-07-19
- Provenance: copied from [gearbox ADR-0015](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0015-rename-to-gearbox.md) (gearbox-install init, upstream sha256:7120736b8852)
- Status: accepted
