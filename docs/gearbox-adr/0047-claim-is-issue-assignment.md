...
- Date: 2026-07-23
- Provenance: copied from [gearbox ADR-0047](https://github.com/real-stanyan/gearbox/blob/master/docs/gearbox-adr/0047-claim-is-issue-assignment.md) (gearbox-install init, upstream sha256:cca193febc78)
- Status: accepted
